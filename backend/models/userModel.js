...
// Checks if a model named "user" already exists in mongoose.models Prevents re-compilation of models if they're already defined Helps avoid the "Cannot overwrite model once compiled" error
