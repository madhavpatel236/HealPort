//  In this Page we will show the appointments of the user for their future appointments.
      ...
      <div  >
        {doctors.slice(0, 2).map((doctor, index) => (
          <div className="grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b" key={index}>
            ...
            <p className="text-xs mt-1"> <span className="text-sm text-neutral-700 font-medium" > Date & Time:</span> 25, jan, 2024 | 10:00 </p>
            </div>
            <div > </div>
